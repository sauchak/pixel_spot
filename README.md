...
<a href="https://pixelspot.herokuapp.com/"> <h1 align=center>Pixel Spot</h1> </a>
...
- [https://pixelspot.herokuapp.com/](https://pixelspot.herokuapp.com/)
...
-------------|------|-----------|-------|---|
`show`|`/users:id`|a user can see all spots a user has created
...
`search`|`/spots/search/all?tags=`|a user can search for spots|`tags`
